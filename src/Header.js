          ...
          <div className="row">
            <div className="col-12 col-lg-6 header-left-side d-flex justify-content-center flex-column align-items-start">
              ...
              <p className="main-hero-para">
                ...
                Consectetur quam velit aspernatur esse veritatis ad eos et sequi
                aut! Deserunt nemo quibusdam accusamus assumenda distinctio
                pariatur ullam facere officiis reiciendis.
              </p>
